...
public class StoreBannerImagesAppsAdapter extends FirebaseRecyclerAdapter<StoreBannerModel, StoreBannerImagesAppsAdapter.ViewHolder> {

    private Context context;

    public StoreBannerImagesAppsAdapter(@NonNull FirebaseRecyclerOptions<StoreBannerModel> options, Context context) {
        super(options);
    ...
    public void onDataChanged() {
        ProgressBar progressBar = ((ManageStoreBannerImages) context).findViewById(R.id.progressBar);
        progressBar.setVisibility(View.GONE);
    }


    @Override
    protected void onBindViewHolder(@NonNull ViewHolder holder, final int position, @NonNull final StoreBannerModel model) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.store_banner_apps_layout, parent, false);
